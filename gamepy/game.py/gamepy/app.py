...
IMAGEM_BACKGROUND = pygame.transform.scale2x(
    pygame.image.load(os.path.join("imgs", "bg.jpg"))
)

IMAGENS_PASSARO = [
    pygame.transform.scale2x(
        pygame.image.load(os.path.join("imgs", "batsf1.png"))
    ),
    pygame.transform.scale2x(
        pygame.image.load(os.path.join("imgs", "batsf2.png"))
    ),
    pygame.transform.scale2x(
        pygame.image.load(os.path.join("imgs", "batsf3.png"))
    )
]
